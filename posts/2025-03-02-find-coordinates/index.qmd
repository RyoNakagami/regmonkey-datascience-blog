...
sns.kdeplot(x=mle_res[:, 0], y=mle_res[:, 1], cmap="Blues", fill=True, ax=ax[0])
sns.kdeplot(x=mle_res[:, 2], cmap="Blues", fill=True, ax=ax[1])

# Show the plot
ax[0].set_xlabel("estimated x coordinate")
ax[0].set_ylabel("estimated y coordinate")
ax[0].set_title("MLE 2D Density Plot\nwith 1000 iterations")
ax[0].set_aspect("equal")
ax[1].set_title("Raidus Density Plot\nwith 1000 iterations")
